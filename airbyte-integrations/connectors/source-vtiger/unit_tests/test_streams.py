...
import pytest
from source_vtiger.source import VtigerStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(VtigerStream, "path", "v0/example_endpoint")
    mocker.patch.object(VtigerStream, "primary_key", "test_primary_key")
    mocker.patch.object(VtigerStream, "__abstractmethods__", set())
